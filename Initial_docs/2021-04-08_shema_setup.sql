...
CREATE TABLE `library`.`users` (
  ...
  `is_admin` BIT(0) NOT NULL,
  `is_deleted` BIT(0) NOT NULL,
  `is_banned` BIT(0) NOT NULL,
  `gender` INT NOT NULL,
...
CREATE TABLE `library`.`books` (
  ...
  INDEX `fk_books_users_users_id_idx` (`created_by` ASC) VISIBLE,
